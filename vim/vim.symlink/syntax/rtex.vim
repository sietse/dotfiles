...
syn region rnowebChunk matchgroup=rnowebDelimiter start="^%% begin.rcode.*" matchgroup=rnowebDelimiter end="^%% end.rcode" contains=@rnowebR,rnowebChunkReference,rnowebChunk fold keepend
...
syn region rnowebSexpr matchgroup=Delimiter start="\\rinline{" matchgroup=Delimiter end="}" contains=@rnowebR
